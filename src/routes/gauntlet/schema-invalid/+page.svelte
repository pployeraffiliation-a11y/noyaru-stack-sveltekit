...
<svelte:head>
  ...
  <link rel="canonical" href="https://noyaru-stack-sveltekit.netlify.app/gauntlet/schema-invalid" />
  ...
  <meta property="og:url" content="https://noyaru-stack-sveltekit.netlify.app/gauntlet/schema-invalid" />
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"SoftwareApplication","name":"Application de test","offers":{"@type":"Offer","price":0,"priceCurrency":"EUR"}}</script>
</svelte:head>
