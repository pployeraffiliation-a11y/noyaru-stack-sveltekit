...
<svelte:head>
  ...
  <meta name="description" content="Page de test spécifique pour le parcours d'obstacles Noyaru, mettant en avant un point particulier pour le crawl." />
  ...
  <meta property="og:description" content="Page de test spécifique pour le parcours d'obstacles Noyaru, mettant en avant un point particulier pour le crawl." />
  ...
  <meta name="twitter:description" content="Page de test spécifique pour le parcours d'obstacles Noyaru, mettant en avant un point particulier pour le crawl." />
