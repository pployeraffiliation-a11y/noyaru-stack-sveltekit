...
<svelte:head>
  ...
  <title>Hreflang non canonique dans le parcours d'obstacles Noyaru</title>
  <meta name="description" content="Cette page traite d'un cas d'hreflang non canonique dans le parcours d'obstacles, illustrant une anomalie spécifique pour le crawl." />
