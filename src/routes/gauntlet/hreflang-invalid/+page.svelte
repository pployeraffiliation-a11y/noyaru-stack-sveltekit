...
<svelte:head>
  ...
  <title>Test de l'anomalie du parcours d'obstacles Noyaru</title>
  <meta name="description" content="Page de test spécifique pour le parcours d'obstacles Noyaru, illustrant une anomalie unique pour le crawl." />
