...
<svelte:head>
  ...
  <title>Erreur hreflang : parcours d'obstacles Noyaru</title>
  <meta name="description" content="Cette page traite des erreurs hreflang et de leur impact sur le SEO, en soulignant les points à corriger pour un meilleur référencement." />
  ...
  <meta property="og:description" content="Cette page traite des erreurs hreflang et de leur impact sur le SEO, en soulignant les points à corriger pour un meilleur référencement." />
  ...
  <meta name="twitter:description" content="Cette page traite des erreurs hreflang et de leur impact sur le SEO, en soulignant les points à corriger pour un meilleur référencement." />
