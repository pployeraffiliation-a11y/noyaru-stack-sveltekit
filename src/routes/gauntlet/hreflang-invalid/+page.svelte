...
<svelte:head>
  ...
  <meta name="description" content="Cette page traite des anomalies liées aux hreflangs invalides dans le parcours d'obstacles Noyaru, avec un point précis à corriger pour le crawl." />
