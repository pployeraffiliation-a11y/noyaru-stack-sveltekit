...
<svelte:head>
  <title>Parcours d'obstacles SEO — Page missing-title</title>
  ...
  <meta property="og:title" content="Parcours d'obstacles SEO — Page missing-title" />
  ...
  <meta name="twitter:title" content="Parcours d'obstacles SEO — Page missing-title" />
