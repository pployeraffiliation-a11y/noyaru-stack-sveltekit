...
<svelte:head>
  <title>Parcours d'obstacles - Anomalie spécifique</title>
  ...
  <meta property="og:title" content="Parcours d'obstacles - Anomalie spécifique" />
  ...
  <meta name="twitter:title" content="Parcours d'obstacles - Anomalie spécifique" />
