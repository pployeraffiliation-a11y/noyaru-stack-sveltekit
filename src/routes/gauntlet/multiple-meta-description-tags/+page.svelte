...
<svelte:head>
  ...
  <meta name="description" content="Apprenez à gérer plusieurs balises de description meta sur votre site en 2023 avec Noyaru Stack SvelteKit pour optimiser votre SEO efficacement." />
