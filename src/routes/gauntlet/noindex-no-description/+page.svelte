...
<svelte:head>
  ...
  <meta property="og:description" content="Page de test du parcours d'obstacles Noyaru servant a provoquer une anomalie SEO unique et controlee dans le cadre des fixtures de validation." />
  ...
  <meta name="twitter:description" content="Page de test du parcours d'obstacles Noyaru servant a provoquer une anomalie SEO unique et controlee dans le cadre des fixtures de validation." />
