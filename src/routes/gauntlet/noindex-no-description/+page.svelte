...
<svelte:head>
  ...
  <meta property="og:description" content="Découvrez le parcours d'obstacles de Noyaru, une expérience unique et captivante." />
  ...
  <meta name="twitter:description" content="Découvrez le parcours d'obstacles de Noyaru, une expérience unique et captivante." />
