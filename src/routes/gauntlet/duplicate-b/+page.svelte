...
<svelte:head>
  ...
  <title>Parcours d'obstacles : duplicate b - Test d'anomalie</title>
  ...
  <meta property="og:title" content="Parcours d'obstacles : duplicate b - Test d'anomalie" />
  ...
  <meta name="twitter:title" content="Parcours d'obstacles : duplicate b - Test d'anomalie" />
