...
<svelte:head>
  ...
  <title>Titre trop long pour le correcteur - Noyaru Stack SvelteKit 2023</title>
  <meta name="description" content="Une meta description trop longue pour dépasser le plafond de cent soixante caractères, afin de déclencher des descriptions non indexables sur cette page." />
  ...
  <meta property="og:url" content="https://noyaru-stack-sveltekit.netlify.app/gauntlet/noindex-long" />
