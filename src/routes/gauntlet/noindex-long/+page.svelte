...
<svelte:head>
  ...
  <meta name="description" content="Une meta description volontairement trop longue pour dépasser le plafond de cent soixante caractères, afin de déclencher les descriptions non indexables." />
