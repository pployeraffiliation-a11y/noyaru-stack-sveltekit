...
<svelte:head>
  ...
  <meta name="twitter:description" content="Découvrez le parcours d'obstacles Noyaru, une expérience unique et stimulante pour tous les amateurs de défis. Rejoignez-nous pour vous amuser !" />
  <meta name="twitter:image" content="https://noyaru-stack-sveltekit.netlify.app/og.png" />
  <meta property="og:description" content="Découvrez le parcours d'obstacles Noyaru, une expérience unique et stimulante pour tous les amateurs de défis. Rejoignez-nous pour vous amuser !" />
</svelte:head>
