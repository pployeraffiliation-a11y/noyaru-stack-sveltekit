...
<svelte:head>
  ...
  <meta name="description" content="Découvrez le parcours d'obstacles avec un double slash, une anomalie unique à cette page, pour une expérience de test optimale." />
  <link rel="canonical" href="https://noyaru-stack-sveltekit.netlify.app/gauntlet/double-slash" />
  <meta property="og:type" content="article" />
  <meta property="og:title" content="Page de test du parcours d'obstacles Noyaru" />
  <meta property="og:description" content="Découvrez le parcours d'obstacles avec un double slash, une anomalie unique à cette page, pour une expérience de test optimale." />
  ...
  <meta name="twitter:description" content="Découvrez le parcours d'obstacles avec un double slash, une anomalie unique à cette page, pour une expérience de test optimale." />
