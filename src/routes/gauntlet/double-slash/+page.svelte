...
<svelte:head>
  ...
  <meta name="description" content="Page de test du parcours d'obstacles Noyaru, illustrant une anomalie spécifique pour la famille visée lors du crawl." />
  ...
  <meta property="og:description" content="Page de test du parcours d'obstacles Noyaru, illustrant une anomalie spécifique pour la famille visée lors du crawl." />
  ...
  <meta name="twitter:description" content="Page de test du parcours d'obstacles Noyaru, illustrant une anomalie spécifique pour la famille visée lors du crawl." />
